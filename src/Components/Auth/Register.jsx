...
const Register = () => {
  const { user, setUser, userSignUp, userSignInWithProvider, userUpdateProfile } =
  ...
  return (
    <section className="py-16 md:p-20 lg:py-32 flex items-center justify-center p-4 dark:bg-bg-dark1">
      <div className="max-w-md w-full bg-bg-color dark:bg-bg-dark2 shadow-2xl rounded-lg p-8">
        <h2 className="text-2xl font-bold text-center text-heading-color dark:text-white mb-6">
          Create an Account
        </h2>
