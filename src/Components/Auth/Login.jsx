...
const Login = () => {
  ...
  return (
    <section className="py-16 md:p-20 lg:py-32 flex items-center justify-center">
      <div className="bg-bg-color shadow-2xl rounded-lg p-6 w-full max-w-sm">
        <form onSubmit={handleLogin} className="space-y-4">
          <h2 className="text-2xl font-bold text-center text-heading-color">Sign In</h2>
          {/* {Email} */}
