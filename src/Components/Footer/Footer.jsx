...
const Footer = () => {
  ...
  return (
    <section className="section bg-bg-color dark:bg-bg-dark2 pt-[60px] md:pt-[40px] pb-4">
      <div className="row border-b border-b-black/50 pb-5 dark:border-b-white/20">
        <div className="column items-center md:items-start">
          ...
          <p className="text text-center md:text-start">
            Your one-stop destination for the best deals and savings. We help
            you shop smarter and save bigger on your favorite brands.
          </p>
        </div>
        ...
        <div className="column">
          ...
          <ul className="text-center text-3xl flex gap-3 justify-center dark:text-white">
            <li>
